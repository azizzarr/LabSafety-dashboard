...
import {ComparitionBarComponent} from "./dialog/Worker_Details/comparition-bar.component";
...
const COMPONENTS = [
  ...
  ComparitionBarComponent,
  WorkerchartListComponent,
];
...
@NgModule({
  ...
  exports: [ToastrComponent, TooltipComponent],
})
