import { Component, AfterViewInit, Input, SimpleChanges, OnChanges, Renderer2, TemplateRef } from '@angular/core';
...
@Component({
  ...
  template: `
    ...
    <div *ngIf="chartDataAvailable">
      <ul>
       <!-- <li *ngFor="let label of ordersChartData.chartLabel"></li>-->
      </ul>
    </div>
    <div *ngIf="chartDataAvailable">
      <ul>
...
export class OrdersChartComponent implements AfterViewInit, OnChanges {
  ...
  ngAfterViewInit(): void {
    ...
    setTimeout(() => this.handleFilterChange('All'), 50);
  }
