...
export class UserActivityService extends UserActivityData {
  ...
  private getDataWeek(): { date: any; pagesVisitCount: number; deltaUp: boolean; name: string[]; newVisits: number }[] {
  ...
  private getDataMonth():
    { date: any; pagesVisitCount: number; deltaUp: boolean; name: string[]; newVisits: number }[] {
  ...
  private getDataYear(): { date: any; pagesVisitCount: number; deltaUp: boolean; name: string[]; newVisits: number }[] {
